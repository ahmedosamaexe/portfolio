...
export const metadata: Metadata = {
  title: "Ahmed Osama • ASP.NET Developer",
  description:
    "Ahmed Osama is an ASP.NET Developer who builds scalable backend systems and AI-powered web applications using .NET, Clean Architecture, and modern web technologies.",
};
