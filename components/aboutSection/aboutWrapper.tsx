...
export function AboutWrapper({}) {
  const [text, setText] = useState({
    main: "Featured Work",
    para: `Building scalable backend systems and AI-powered web applications with ASP.NET Core and Clean Architecture.`,
  });
  useEffect(() => {
    if (!isDesktop()) {
      setText({
        main: "Recent Work",
        para: `Building scalable backends and AI-powered web apps with ASP.NET and Clean Architecture.`,
      });
    }
  }, []);
